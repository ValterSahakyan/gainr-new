                        ...
                        <div className="relative flex h-full w-full items-center px-4 py-14 md:px-12 lg:px-20">
                            <div className="max-w-[760px]">
                                <h1 className="text-[34px] font-medium leading-[1.02] tracking-[-0.02em] text-white md:text-[62px]">
                                    Product <span className="text-brand">Coming Soon</span>
                                </h1>
                                <p className="mt-6 max-w-[860px] text-[18px] leading-[1.35] text-[#e5e7ec] md:text-[30px]">
                                    This app is under active development. We are finalizing integrations, reliability testing, and user flows
                ...
                <section className="w-full rounded-[30px] bg-[#e8e8eb] py-10 md:py-12">
                    <div className={SECTION_INNER_PADDING}>
                        ...
                        <p className="mt-3 max-w-[1050px] text-[18px] leading-[1.3] text-[#3f4249] md:text-[34px]">
                            We are completing product hardening, performance optimization, and launch-readiness checks.
                        </p>

                        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div className="rounded-[20px] bg-[#EFEFF1] p-5">
                                <h3 className="mt-2 text-[22px] font-medium leading-none text-[#23262d] md:text-[26px]">Platform readiness</h3>
                                <p className="mt-3 text-[15px] leading-[1.5] text-[#5a6070]">Final QA, monitoring, and load testing across app modules.</p>
                            </div>
                            <div className="rounded-[20px] bg-[#EFEFF1] p-5">
                                <h3 className="mt-2 text-[22px] font-medium leading-none text-[#23262d] md:text-[26px]">User experience</h3>
                                <p className="mt-3 text-[15px] leading-[1.5] text-[#5a6070]">Refining onboarding, wallet flow, and in-app interaction patterns.</p>
                            </div>
                            <div className="rounded-[20px] bg-[#EFEFF1] p-5">
                                <h3 className="mt-2 text-[22px] font-medium leading-none text-[#23262d] md:text-[26px]">Launch rollout</h3>
                                <p className="mt-3 text-[15px] leading-[1.5] text-[#5a6070]">Staged release with support docs and ecosystem announcements.</p>
                            </div>
                        </div>

                        <div className="mt-8 flex flex-wrap gap-3">
                            <Button asChild className="h-auto rounded-full bg-brand px-6 py-2.5 text-sm font-medium text-white hover:bg-brand-hover">
                                <Link to="/ecosystem">Back to ecosystem</Link>
                            </Button>
                            <Button
                                asChild
                                className="h-auto rounded-full bg-[#d9dce3] px-6 py-2.5 text-sm text-[#2e3440] hover:bg-[#d0d4dc]"
                            >
